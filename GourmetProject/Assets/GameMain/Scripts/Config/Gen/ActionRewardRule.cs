...
namespace cfg
{
public sealed partial class ActionRewardRule : Luban.BeanBase
{
    public ActionRewardRule(JSONNode _buf) 
    {
    ...
    public static ActionRewardRule DeserializeActionRewardRule(JSONNode _buf)
    {
        return new ActionRewardRule(_buf);
    }
    ...
    public const int __ID__ = 1577778625;
