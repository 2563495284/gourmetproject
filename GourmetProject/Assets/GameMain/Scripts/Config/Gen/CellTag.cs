...
namespace cfg
{
public sealed partial class CellTag : Luban.BeanBase
{
    public CellTag(JSONNode _buf) 
    {
    ...
    public static CellTag DeserializeCellTag(JSONNode _buf)
    {
        return new CellTag(_buf);
    }
    ...
    public const int __ID__ = -1967177032;
