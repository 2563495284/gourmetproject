...
{
    /// <summary>一次棋盘居中定位的结果：自适应单格世界尺寸 + 棋盘根世界坐标。</summary>
    ...
    /// <summary>
    /// 棋盘在世界空间的居中定位计算（Food 态与棋盘编辑/胃视图态共用）。
    ...
    public static class BoardLayout
    {
        ...
        /// <summary>按视口半宽/半高与胃包围盒，算出铺满可用区且居中的单格尺寸与棋盘根位置。</summary>
        public static BoardPlacement Compute(float halfW, float halfH, GpBoard board, float bottomMargin)
        {
