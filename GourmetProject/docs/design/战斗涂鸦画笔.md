...
| `Assets/GameMain/UI/BattleForm.prefab` | `HudFrame/FoodActions` 下预置 `Eat` / `Overview` / 涂鸦清空 / 涂鸦显隐按钮 |
| `Assets/GameMain/Scenes/Battle.unity` | `BattleSceneRoot/DoodleRoot` 挂控制器；涂鸦按钮已迁出场景 |
