# Flat square dining-table materials v2

Eight 320×320 PNG source sprites with alpha. Every sprite uses the same
304×304 non-transparent footprint at offset `+8,+8`. No table legs, side
thickness, plates, food, labels, or cast shadows.
...
- `board_cell_flat_m_obsidian.png` — 黑曜石 / obsidian
- `board_cell_flat_m_emerald.png` — 翡翠 / emerald
- `board_cell_flat_m_gold.png` — 金 / gold
- `board_cell_flat_m_silver.png` — 银 / silver
...
transparent PNG files as source assets.
